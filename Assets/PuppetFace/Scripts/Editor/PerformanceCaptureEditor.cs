...
namespace PuppetFace
{
	...
	public class PerformanceCaptureEditor : Editor
	{
		...
		void OnEnable()
		{
			...
			if (pc.faces == null)
			{
				TextAsset t = AssetDatabase.LoadAssetAtPath("Assets/PuppetFace/Scripts/faceDefaults.xml", typeof(TextAsset)) as TextAsset;
				pc.faces = t;
			}
			if (pc.eyes == null)
			{
				TextAsset t = AssetDatabase.LoadAssetAtPath("Assets/PuppetFace/Scripts/eyeDefaults.xml", typeof(TextAsset)) as TextAsset;
				pc.eyes = t;
			}
			if (pc.shapes == null)
			{
				TextAsset t = AssetDatabase.LoadAssetAtPath("Assets/PuppetFace/Scripts/shape_predictor_68_face_landmarks.bytes", typeof(TextAsset)) as TextAsset;
				pc.shapes = t;
			}
			if (pc.Surface == null)
			{
