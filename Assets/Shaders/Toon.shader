...
/* TCP_DATA u config(unity:"2020.3.20f1";ver:"2.7.0";tmplt:"SG2_Template_Default";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","RIM_DIR","SKETCH_SHADER_FEATURE","SKETCH_AMBIENT","OUTLINE","RIM_OUTLINE","AUTO_TRANSPARENT_BLENDING","OUTLINE_BEHIND_DEPTH","SPECULAR_SHADER_FEATURE","RIM_SHADER_FEATURE","BUMP_SCALE","WORLD_NORMAL_FROM_BUMP","TEXTURE_RAMP","TEXTURE_RAMP_SLIDERS","OUTLINE_DEPTH","OUTLINE_CLIP_SPACE","UNITY_2020_1","ENABLE_LIGHTMAPS","ENABLE_FOG","ENABLE_LPPV","UNITY_2019_4","DEPTH_PREPASS","OUTLINE_BLENDING"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Outline"];shaderProperties:list[,,sp(name:"Alpha";imps:list[imp_mp_range(def:1;min:0;max:1;prop:"_Alpha";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"b5dbc15a-250d-4a4e-a124-7eb5f00febf1";op:Multiply;lbl:"Alpha";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,,,,,,,,,,,,,,,,,,,,,,,,,,sp(name:"Blend Operation";imps:list[imp_enum(value_type:0;value:1;enum_type:"ToonyColorsPro.ShaderGenerator.BlendOperation";guid:"fbdee238-66bf-4252-95a9-407b2cb6e4d5";op:Multiply;lbl:"Blend Operation";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),sp(name:"Specular Toon Smoothness";imps:list[imp_mp_range(def:0.05;min:0.001;max:0.5;prop:"_SpecularToonSmoothness";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"5b0f9462-c584-4303-a523-b9ffe856997c";op:Multiply;lbl:"Toon Smoothness";gpu_inst:False;locked:False;impl_index:0),imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:1;chan:"R";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_SpecularToonSmoothnessTex";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"523e7902-2c47-46f7-95bb-87140b5a9263";op:Multiply;lbl:"Specular Toon Smoothness Texture";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 4dc990a9ba622e46f3767dd24cd8482a */
